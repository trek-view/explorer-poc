...
class Photo < ApplicationRecord
  ...
  store_accessor :address, :locality, :administrative_area_level_3, :administrative_area_level_2, :administrative_area_level_1, :postal_code, :country, :country_code, :place_id, :plus_code
