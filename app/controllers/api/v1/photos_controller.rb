    ...
    private
      ...
      def permitted_photo_params
        [:image,
         ...
         :camera_make,
         :camera_model,
         address: [:locality, :administrative_area_level_3, :administrative_area_level_2, :administrative_area_level_1, :postal_code, :country, :country_code, :place_id, :plus_code_global_code, :plus_code_compound_code],
