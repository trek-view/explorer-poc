...
module PhotosHelper
  ...
  def pannellum_iframe(photo)
    '<iframe width="600" height="400" allowfullscreen style="border-style:none;" src="https://cdn.pannellum.org/2.5/pannellum.htm#panorama=' + photo.image.url(:med) + '&amp;amp;title=' + URI.encode(photo.tour.name) + '&amp;amp;author=' + URI.encode(photo.tour.user.name) + '&amp;amp;authorURL=' + URI.encode(photo_url(photo)) + '&amp;amp;autoLoad=true"></iframe>'
  end
